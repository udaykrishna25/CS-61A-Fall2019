...
def taxicab(a, b):
    ...
    street_distance = abs(street_a - street_b)
    avenue_distance = abs(avenue_a - avenue_b)
...
def balanced(m):
    ...
    if is_weight(m):
        ...
        torque_left = left(m)[1] * total_weight(left_end)
        torque_right = right(m)[1] * total_weight(right_end)
