...
def is_swap(player_score, opponent_score):
    ...
    def first_digit(n):
        while n >= 10:
            n = n / 10
        return int(n)
    if player_score % 10 * first_digit(player_score) == opponent_score % 10 * first_digit(opponent_score):
        return True
    else:
        return False
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if player == 0:
            ...
            current_score0 = take_turn(num_rolls, score1, dice)
            score0 += current_score0
            if feral_hogs and abs(num_rolls - feral_hog_player0) == 2:
                score0 += 3
            feral_hog_player0 = num_rolls
        elif player == 1:
            num_rolls = strategy1(score1, score0)
            current_score1 = take_turn(num_rolls, score0, dice)
            score1 += current_score1
            if feral_hogs and abs(num_rolls - feral_hog_player1) == 2:
                score1 += 3
            feral_hog_player1 = num_rolls
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    while k <= 10:
        ...
        max_score_k = averaged_roll_dice(k, dice)
        if max_score_k > max_score:
            max_score = max_score_k
            num_max_score = k
        k += 1
    return num_max_score
    # END PROBLEM 9
